...
try {
	$callback = function ($update, $bot) {
      ...
      $accounts = json_decode(file_get_contents('accounts.json'),1);
       ...
       mkdir("$from_id/1");       
      usleep(400000);
      system("cp -r  rodkr.zip $from_id/1 ");
...
'text'=>"تم حظرك ",
              ...
              $bot->sendphoto([ 'chat_id'=>$chatId,
                  'photo'=>"https://t.me/aoo1_1/179",
                   'caption'=>'𓊈 𝑊𝐸𝐿𝐿𝐶𝑀𝐸 𓊉 ارحبوا تم التفعيل من الاسطوره رودكر @rosnw1 ,
                  'reply_markup'=>json_encode([
                      'inline_keyboard'=>[
          	...
          	if($config['mode'] != null){
                  ...
                  'reply_markup'=>json_encode([
                      'inline_keyboard'=>[
                          ...
                          [['text'=>' قناتي❗','url'=>'t.me/rosnw1'],['text'=>'المطور❔','url'=>'t.me/rwwwr']],
                      ]
                  ])
                  ]);
            ...
            $bot->editMessageText([
                ...
                'reply_markup'=>json_encode([
                    'inline_keyboard'=>[
                        ...
                        [['text'=>'هاشتاق','callback_data'=>'hashtag'],['text'=>'📈 من الاكسبلور','callback_data'=>'explore']],
...
$bot->sendMessage([
            ...
            $bot->sendMessage([
                'chat_id'=>$chatId,
                'text'=>"الان قم بأرسال الهاشتاق بدون علامه # يمكنك 🧿استخدام هاشتاق واحد فقط"
            ]);
            $config['mode'] = 'hashtag';
            file_put_contents('config.json', json_encode($config));
          } elseif($data == 'newList'){
...
في الاسفل هي حساباتك الوهميه المسجله في الاداة",
                  'reply_markup'=>json_encode([
                      'inline_keyboard'=>[
                          ...
                          [['text'=>'بدء الصيد 💀','callback_data'=>'run'],['text'=>'ايقاف الصيد💀','callback_data'=>'stop']],
                          [['text'=>'حاله الحسابات ⚒','callback_data'=>'status'],['text'=>'قسم خاص ✔','callback_data'=>'statusakil']],
 [['text'=>' قناتنا','url'=>'t.me/Rosnw1'],['text'=>'مطور السورس','url'=>'t.me/rwwwr']],
                      ]
                  ])
                  ]);		
 ...
 [['text'=>' قناتنا','url'=>'t.me/rosnw1'],['text'=>'مطور السورس','url'=>'t.me/rwwwr']],
          	...
          	$bot->editMessageText([
                      'chat_id'=>$chatId,
                      'message_id'=>$mid,
                     'text'=> "اختراق المتاح :- اختراق حسابات انستقرام المتاحه هو اختراق غير محدد وينطبق على  حسابات التي تتوفر فيها شروط معينه

 س / ماهو متاح وما هي فكره المتاح؟

ج /  عندما تنشى حساب انستقرام جديد 
يطلب منك ايميل  هنالك اشخاص تقوم بـ اضافه ايميل وهمي غير مربوط بالجهاز فـ هذه الحساب يسمى متاح 
او
حساب انستقرام مربوط ببريد ياهو او هوتميل لم يفتح صاحبه البريد لمدة سنه كامله
...
اختراق المتاح :-  بكل سهوله و بساطة تقوم بي. تأكد من نوع متاح هل هوا Gmail او hotmail او yahoo او maill اَو غيرها وتقوم بل دخول لي مواقع  انشاء حسابات مثل Gmail  تدخل اضافة حساب وتختار جيميل وتنشئ حساب جديد و وتضيف البريد الإلكتروني الخاص بل حساب المتاح و تقوم بي عمل Rest  من الانستقرام و يصل رابط تغير كلمه سر الحساب

الي  مافهم يكلمني على الخاص
@rwwwr",
                  'reply_markup'=>json_encode([
                      'inline_keyboard'=>[
...
في الاسفل هي حساباتك الوهميه المسجله في الاداة",
                  'reply_markup'=>json_encode([
                      'inline_keyboard'=>[
                          ...
                          [['text'=>'بدء الصيد 💀','callback_data'=>'run'],['text'=>'ايقاف الصيد💀','callback_data'=>'stop']],
                          [['text'=>'حاله الحسابات ⚒','callback_data'=>'status'],['text'=>'قسم خاص ✔','callback_data'=>'statusakil']],
 [['text'=>' فناتنا','url'=>'t.me/Rosnw1'],['text'=>'مطور السورس','url'=>'t.me/rwwwr']],
                      ]
                  ])
                  ]);
          } else {
